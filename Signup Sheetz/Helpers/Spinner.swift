...
//  WorkDigital
//
//  Created by Mohammad Kaif on 25/05/22.
//
...
open class Spinner {
    ...
    public static var style: UIActivityIndicatorView.Style = UIActivityIndicatorView.Style.medium
    public static var baseBackColor = UIColor(white: 0, alpha: 0.6)
    public static var baseColor = UIColor.red
    
    
    public static func start() {
        Spinner.start(style: UIActivityIndicatorView.Style.large)
    }
